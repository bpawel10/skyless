...
// FIXME: remove this? cause we now have different health
// and probably we can get rid of most of attrs here, if not all?
// I mean, we need to remove systems/core, and use new modules structure instead
#[attribute]
pub struct Health {
    pub value: u16,
    pub max: u16,
